    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                <div>
                    <h1 className="text-2xl font-bold sm:text-3xl lg:text-4xl tracking-tight mb-2 bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <motion.div variants={item}>
                    <Card className="min-w-0 bg-card hover:bg-card/80 transition-all border-border/40">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <motion.div variants={item}>
                        <Card className="min-w-0 bg-gradient-to-br from-primary/10 via-background to-background border-primary/20 overflow-hidden relative group">
                            <div className="absolute top-0 right-0 p-4 sm:p-6 lg:p-8 transform translate-x-4 -translate-y-4 opacity-10 group-hover:opacity-20 transition-opacity">
                    ...
                    <motion.div variants={item}>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-xl sm:text-2xl font-bold">Suggested Actions</h2>
                        </div>
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <Card className="min-w-0 bg-card hover:border-primary/50 transition-colors cursor-pointer" onClick={() => router.push("/reports")}>
                            ...
                            <Card className="min-w-0 bg-card hover:border-primary/50 transition-colors cursor-pointer" onClick={() => router.push("/usage")}>
                                <CardHeader className="p-4">
                                    <div className="flex items-center gap-3">
                ...
                <div className="space-y-6">
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-3">
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="text-sm font-medium break-words">NVIDIA RTX 50-series availability tracking started.</p>
                                    </div>
                                    <div className="flex flex-col gap-1">
                                        <span className="text-xs text-muted-foreground">Value Alert</span>
                                        <p className="text-sm font-medium break-words">AMD Ryzen 7800X3D maintains peak value-for-gaming.</p>
                                    </div>
                                </div>
                    ...
                    <motion.div variants={item}>
                        <Card className="min-w-0 bg-zinc-950 border-zinc-800">
